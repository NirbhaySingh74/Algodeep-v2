...
import { Briefcase, ExternalLink, Star, Clock, Search, Filter, ArrowUpDown, CheckCircle } from "lucide-react";
...
const CompaniesView: React.FC = () => {
  ...
  const filteredProblems = useMemo(() => {
    ...
    return filtered;
  }, [companyProblems, difficultyFilter, searchQuery, sortConfig, viewMode, favorites, solvedStatus]);
  ...
  return (
    <motion.div
      ...
      className="pb-10"
    >
      {/* Company grid with improved grid system */}
      <motion.div
        className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 md:gap-4 mb-6"
      ...
      >
        {companies.map((company, index) => (
          <motion.div
            ...
            animate="visible"
          >
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gray-800 p-3 mb-3 flex items-center justify-center">
              <img
                src={company.logo}
                alt={company.name}
            ...
            <span className="text-xs text-gray-300 text-center font-medium mt-1">{company.name}</span>
            <span className="text-xs text-gray-500 mt-1">{Math.floor(Math.random() * 100) + 10} problems</span>
          </motion.div>
        ))}
      </motion.div>
      ...
      <AnimatePresence mode="wait">
        {selectedCompany && (
          ...
          >
            <div className="p-5 border-b border-gray-800">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-800 p-2 mr-4 flex items-center justify-center">
                    <img
                  ...
                  <div>
                    <h3 className="text-xl font-medium">
                      {companies.find((c) => c.id === selectedCompany)?.name} Interview Questions
                    </h3>
                ...
                <div className="hidden md:flex gap-2">
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <Button
                      ...
                      className={`text-xs ${viewMode === "solved" ? "bg-green-800" : ""}`}
                    ...
                    <Button
                      ...
                      className={`text-xs ${viewMode === "favorites" ? "bg-amber-800" : ""}`}
            ...
            <div className="overflow-x-auto">
                ...
                <thead className="bg-gray-800">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider w-16">
                      <div className="flex items-center gap-1 cursor-pointer" onClick={() => requestSort("solved")}>
                        Status
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">
                      <div className="flex items-center gap-1 cursor-pointer" onClick={() => requestSort("Title")}>
                        Title
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider w-28">
                      <div className="flex items-center gap-1 cursor-pointer" onClick={() => requestSort("Difficulty")}>
                        Difficulty
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider w-28">
                      <div className="flex items-center gap-1 cursor-pointer" onClick={() => requestSort("Frequency")}>
                        Frequency
                    ...
                    paginatedProblems.map((problem, index) => (
                      ...
                      >
                        <td className="px-4 py-3 whitespace-nowrap">
                          <SimpleTooltip content={solvedStatus[problem.ID] ? "Mark as unsolved" : "Mark as solved"}>
                            <motion.div
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                              ${difficultyColors[problem.Difficulty].bg} ${difficultyColors[problem.Difficulty].text}`}
                          >
                            {problem.Difficulty}
                          </span>
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                              ${getFrequencyColor(parseFloat(problem.Frequency)).bg} 
                              ${getFrequencyColor(parseFloat(problem.Frequency)).text}`}
                          >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          <div className="flex space-x-2">
                            ...
                            <SimpleTooltip content={favorites[problem.ID] ? "Remove from favorites" : "Add to favorites"}>
                              <motion.button
              ...
              {paginatedProblems.length > 0 && paginatedProblems.length < filteredProblems.length && (
       ...
       {!selectedCompany && (
        ...
        >
          ...
          <p className="text-gray-400 max-w-md mx-auto">
            Choose a company above to see frequently asked interview questions tailored to your target company. Track your progress and ace your next technical interview.
          </p>
